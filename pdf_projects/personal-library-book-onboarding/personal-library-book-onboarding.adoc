...
. Open the Libib mobile app and select *Scottinez Books*.
. Select image:resources/images/libib-plus.png[title=Libib + button,20,20] and then select *Manual*.
. Select *Book*.
...
. Select image:resources/images/libib-meatballs.PNG[title=Libib book meatball menu,20,20] and then select *Edit*.
...
. Select image:resources/images/libib-meatballs.PNG[title=Libib book meatball menu,20,20] and then select *Delete*.
