...
+
--
NOTE: Libib adds the book to the collection as soon as you scan the barcode. The total book count won't update until you select *Done* to finish scanning.
--
+
. Optionally, select *Add another* to add another book.
. Select *Done* to finish scanning books.

The total count book count refreshes to show your new total.
...
+
--
NOTE: Libib adds the book to the collection as soon as you add the book. The total count won't update until you select *Done* to finish adding books. A green confirmation message appears along the top of the screen.
--
+
. Optionally, select *Add another* to add another book.
...
In the sidebar menu, select *Library* to return to the library. The total count book count refreshes to show your new total.
...
Select *Library* to return to the library. The total count book count refreshes to show your new total.
