...
image::add-new-book.drawio.png["A flowchart showing decisions a user must make when adding a book to a Libib collection.",550,200]
...
. Select image:libib-plus.png[Libib + button,20,20] and then select *Barcode*.
. Select *Book*.
. Center the book's barcode on your screen using your phone's camera. Libib automatically captures the barcode. A confirmation message appears along the top of the screen.
+
--
NOTE: Libib adds the book to the collection as soon as you scan the barcode. The total book count next to _Scottinez Books_ won't update until you select *Done* to finish scanning.
--
+
. Optionally, select *Add another* to add another book.
. Select *Done* to finish scanning books.

The total book count next to _Scottinez Books_ refreshes to show your new total.

=== Search by ISBN 13 or ISBN 10

Some books don't have a barcode or their barcode is invalid. If you can't find the book by its barcode, search for the book by its ISBN 13 or ISBN 10.
...
. Select image:libib-plus.png[Libib + button,20,20] and then select *Barcode*.
. Select *Book*.
. Enter the ISBN 13 or ISBN 10 in the search bar along the top of the screen and then tap *return*. A green confirmation message appears along the top of the screen.
+
--
NOTE: Libib adds the book to the collection as soon as you tap *return*. The total count next to _Scottinez Books_ won't update until you select *Done* to finish adding books.
--
+
. Optionally, select *Add another* to add another book.
. Select *Done* to finish adding books.
...
In the sidebar menu, select *Library* to return to the library. The total book count next to _Scottinez Books_ refreshes to show your new total.
...
. Open the Libib mobile app and select *Scottinez Books*.
. Select image:libib-plus.png[Libib + button,20,20] and then select *Manual*.
. Select *Book*.
...
Select *Library* to return to the library. The total book count next to _Scottinez Books_ refreshes to show your new total.
...
. Select image:libib-meatballs.PNG[Libib book meatball menu,20,20] and then select *Edit*.
...
. Open the Libib mobile app and select *Scottinez Books*.
. Select the book that you want to edit.
. Select image:libib-meatballs.PNG[Libib book meatball menu,20,20] and then select *Image*.
...
. Select image:libib-save-icon.PNG[Libib upload photo save icon,20,20].
...
. Select image:libib-meatballs.PNG[Libib book meatball menu,20,20] and then select *Delete*.
. Select *Delete* again to confirm.

A green confirmation message appears along the top of the screen.

You're automatically returned to the library. The total book count next to _Scottinez Books_ refreshes to show your new total.
...
When you scan a book that already exists in the collection, select *Done* or *Add another* to avoid adding an extra copy.
...
. Open the Libib mobile app and select *Scottinez Books*.
. Select the book that you want to edit.
. Select image:libib-meatballs.PNG[Libib book meatball menu,20,20] and then select *Copies*.
. Select image:libib-trashcan.PNG[Libib trashcan icon in copies menu,20,20] and then select *Delete* to confirm.
