...
+
--
NOTE: Libib adds the book to the collection as soon as you scan the barcode. The total book count next to _Scottinez Books_ won't update until you select *Done* to finish scanning. A green confirmation message appears along the top of the screen.
--
+
...
+
--
NOTE: Libib adds the book to the collection as soon as you tap *return*. The total count next to _Scottinez Books_ won't update until you select *Done* to finish adding books. A green confirmation message appears along the top of the screen.
--
+
. Optionally, select *Add another* to add another book.
