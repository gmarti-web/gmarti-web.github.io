...
:page-last_modified_at: 2025-12-08
...
image::add-new-book.drawio.png["A flowchart showing decisions a user must make when adding a book to a Libib collection.",500,200]
...
+
--
NOTE: Libib adds the book to the collection as soon as you scan the barcode. The total book count next to _Scottinez Books_ won't update until you select *Done*.
--
+
...
+
--
NOTE: Libib adds the book to the collection as soon as you tap *return*. The total book count next to _Scottinez Books_ won't update until you select *Done*.
--
+
. Optionally, select *Add another* to add another book.
