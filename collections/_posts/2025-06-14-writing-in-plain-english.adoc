...
Morew than 25 years ago, a devastating form of immunodeficiency appeared, the acuquired immune deficiency syndrome, or AIDS, which is caused by an infectious agent, the human immunodeficiency viruses HIV-1 and HIV-22. This disease destroys T cells, dendritic cells, and macrophages bearing CD4, leading to infections caused by intracellular bacteria and other pathogens normally controlled by such cells. These infections are the major cause of death from this increasingly prevalent immunodeficiency disease.
+
====
